...
public class PlayerBehaviour : MonoBehaviour
{
    ...
    public float removeBatteryValue = 5.0f;
    public float secondToRemoveBaterry = 20.0f;
	...
	void Update ()
    {
        ...
        // page system
        pagesCount.GetComponent<Text>().text = "Collected Pages: " + collectedPages + "/11";
